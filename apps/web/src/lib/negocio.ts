export const NEGOCIO = {
  ...
  // Coordenadas reales del local, tomadas del mismo embed de Google Maps
  // de abajo (parámetros 2d/3d de la URL) — no son un valor inventado.
  latitud: 11.540325688658731,
  longitud: -72.90701922494681,
  // Datos reales de transferencia (Banco Nu) — el negocio usa la llave en
  // vez de un número de cuenta clásico, así funciona Nu Colombia.
  transferencia: { banco: 'Nu', llave: '1118843420' },
  mapaEmbedUrl:
